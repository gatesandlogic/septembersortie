...
public class PCRocketLoli extends MapUnit{
	...
	public PCRocketLoli(Sortie game, GameBoard gb, int x, int y, String name)
	{
		super(game, gb, Team.GREEN, 10, name, 10);
		...
		Texture lolitex = game.assman.get("lolis/mapunits/rocketloli.png");
		...
		TextureRegion [] temp3 = {new TextureRegion(lolitex, 48, 0, 16, 16), new TextureRegion(lolitex, 64, 0, 16, 16)};
		attack = new Animation(0.3f,temp3);
		//attack.setPlayMode(PlayMode.LOOP);
		
		TextureRegion [] temp4 = new TextureRegion[4];
		for(int i = 0; i < 3; i++)
			temp4[i] = new TextureRegion(lolitex, 80 + (16 * i), 0, 16, 16);
		temp4[3] = new TextureRegion(lolitex, 0, 16, 16, 16);
		salute = new Animation(0.1f,temp4);
		salute.setPlayMode(PlayMode.LOOP_PINGPONG);
		
		TextureRegion [] temp5 = {new TextureRegion(lolitex, 16, 16, 16, 16), new TextureRegion(lolitex, 32, 16, 16, 16)};
		hurt = new Animation(0.15f,temp5);
		hurt.setPlayMode(PlayMode.LOOP);
		
		
		TextureRegion [] temp6 = new TextureRegion[5];
		for(int i = 0; i < 5; i++)
			temp6[i] = new TextureRegion(lolitex, 48 + (i * 16), 16, 16, 16);
